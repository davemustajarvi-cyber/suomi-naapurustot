...
# Lisätty suffix-parametri, jotta avaimet ovat uniikkeja
def nayta_statsit(row, context, p_nro, winner_tags=None, suffix=""):
    ...
    # UNIikki avain yhdistämällä postinumero ja suffix
